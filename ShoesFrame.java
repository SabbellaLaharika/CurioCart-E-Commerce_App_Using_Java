...
public class ShoesFrame extends JFrame implements ActionListener{
    JButton backButton;
    public ShoesFrame() {
        setTitle("CurioCart/Categories/Fashion/Shoes");
        ...
        shoesLabel.setFont(new Font(shoesLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/Fashion/Shoes/VectorX.jpg",
        ...
        String[] brands={"VectorX","Lify","Asian","Avant","Bourge","Sparx"};
        String[] prices = {"\n   849/-","\n   566/-","\n   1299/-","\n   1,469/-","\n   619/-","\n 1,135/-"};
        ...
        headerPanel.add(shoesLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from shoes where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update shoes set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
