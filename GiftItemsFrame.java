...
public class GiftItemsFrame extends JFrame implements ActionListener{
    JButton backButton;
    public GiftItemsFrame() {
        setTitle("CurioCart/Categories/Essentials/Gifts");
        ...
        JLabel giftItemsLabel = new JLabel("Gift Items");
        giftItemsLabel.setFont(new Font(giftItemsLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/Essentials/Gift/1 (2).png",
                            ...
                            String[] brands = {
                                ...
                                "Water Bottle with UV Water Purification",
                                "Portable Charger"
                            };
        ...
        headerPanel.add(giftItemsLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from gifts where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update gifts set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
