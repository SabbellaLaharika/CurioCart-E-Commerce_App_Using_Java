...
public class SoapsAndShampoosFrame extends JFrame implements ActionListener{
    JButton backButton;
    public SoapsAndShampoosFrame() {
        setTitle("CurioCart/Categories/Essentials/SoapsAndShampoos");
        ...
        JLabel soapsAndShampoosLabel = new JLabel("Soaps and Shampoos");
        soapsAndShampoosLabel.setFont(new Font(soapsAndShampoosLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/Essentials/SoapsAndShampoos/1.png",
        ...
        String[] brands = {"Head & Shoulders Shampoo",
                            "Dove Moisturizing Shampoo",
                            "Pantene Pro-V Sheer Shampoo",
                            "Mysore Sandal Shampoo",
                            "Mama Eart Soap"};
        ...
        JLabel blankSpaceLabel = new JLabel("icsudhjfoehlfoehImages/Essentials/SoapsAndShampoos/1.png ");
        ...
        headerPanel.add(soapsAndShampoosLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from shampoos where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update shampoos set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
