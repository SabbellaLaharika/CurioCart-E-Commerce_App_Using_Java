...
public class LightsFrame extends JFrame implements ActionListener{
    JButton backButton;
    public LightsFrame() {
        setTitle("CurioCart/Categories/Electronics/Lights");
        ...
        lightsLabel.setFont(new Font(lightsLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/Electronics/Lights/Panasonic9WMotionSensorBulb.jpg",
        ...
        String[] brands = {"Panasonic Sensor Bulb  ",
                            "Groeien 15W Rectangular LED ",
                            "Crompton Laser Ray Neo 20W LED Batten ",
                            "GreyWings Wooden Wall Lamp Light",
        ...
        headerPanel.add(lightsLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from lights where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update lights set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
