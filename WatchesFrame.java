...
public class WatchesFrame extends JFrame implements ActionListener{
    JButton backButton;
    public WatchesFrame() {
        setTitle("CurioCart/Categories/Fashion/Watches");
        ...
        JLabel watchesLabel = new JLabel("Watches");
        watchesLabel.setFont(new Font(watchesLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/Fashion/Watches/Rolex Submariner.jpg",
        ...
        headerPanel.add(watchesLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from watches where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update watches set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
