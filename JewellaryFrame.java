...
public class JewellaryFrame extends JFrame implements ActionListener{
    JButton backButton;
    public JewellaryFrame() {
        setTitle("CurioCart/Categories/Cosmetics and Jewellary/Jewellary");
        ...
        JLabel jewellaryLabel = new JLabel("Jewellary");
        jewellaryLabel.setFont(new Font(jewellaryLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/CosmeticsAndJewellary/Jewellery/1.png",
        ...
        String[] brands = {"Tiffany & Co. Diamond Necklace and Earrings Set",
                           "Pandora Charm Bracelet",
                           "Kate Spade Statement Necklace",
                           "Swarovski Crystal Ring",
                           "Michael Kors Watch and Bracelet Set"
                            };
        ...
        headerPanel.add(jewellaryLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from jewellery where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update jewellery set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
