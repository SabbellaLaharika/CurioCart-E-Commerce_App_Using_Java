...
public class EaringsFrame extends JFrame implements ActionListener{
    JButton backButton;
    public EaringsFrame() {
        setTitle("CurioCart/Categories/Cosmetics and Jewellary/Earings");
        ...
        JLabel earingsLabel = new JLabel("Earings");
        earingsLabel.setFont(new Font(earingsLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/CosmeticsAndJewellary/Earings/1.png",
        ...
        headerPanel.add(earingsLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from earrings where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update earrings set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
