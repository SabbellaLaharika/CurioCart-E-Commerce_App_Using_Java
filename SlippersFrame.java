...
public class SlippersFrame extends JFrame implements ActionListener{
    JButton backButton;
    public SlippersFrame() {
        setTitle("CurioCart/Categories/Fashion/Slippers");
        ...
        JLabel slippersLabel = new JLabel("Slippers");
        slippersLabel.setFont(new Font(slippersLabel.getFont().getFontName(),Font.BOLD,30));

        String[] images = {"Images/Fashion/Slippers/Elena.jpg",
...
String[] brands = {"Elena","Flite","Koburg","OrthoCare","Puma","SoftSandals"};
String[] prices = {"\n   281/-","\n   266/-","\n  549/-","\n   399/-","\n   1,499/-","\n 1290/-"};
...
String[] features={"Features:\n•  Women's New Elena Slipper\n•  Flat Daily Use Slippers\n•  Bata Sunshine",
        ...
        headerPanel.add(slippersLabel,BorderLayout.CENTER);
                ...
                buyButton.addActionListener(new ActionListener() { 
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            ...
                            ResultSet rs = st.executeQuery("select stockAvail from slippers where sno = " + k);
                            if(rs.next())
                        ...
                        if (count > 0) {
                            ...
                            try
                            {
                                ...
                                st.executeUpdate("update slippers set stockAvail = " + newCount + " where sno = " + l);
                            }
                            catch(SQLException exp){
                                System.out.println(exp);
                            }
